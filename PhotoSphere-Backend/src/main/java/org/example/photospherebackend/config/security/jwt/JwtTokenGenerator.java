...
public class JwtTokenGenerator {
    ...
    public String generateAccessToken(Authentication authentication, AppUser user) {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder()
                ...
                .claim("scope", role)
                .claim("firstName", getUserFirstName(user))
                .claim("lastName", getUserLastName(user))
                .build();
    ...
    private String getUserFirstName(AppUser user) {
        return user.getFirstName();
    }

    private String getUserLastName(AppUser user) {
        return user.getFirstName();
    }
